...
function buildShipBriefPromptText(days) {
  return [
    ...
    "",
    "Goal",
    "- Produce five sections: Engineering changelog, PM/Marketing brief, Support note, Audit report, Business Impact (ROI).",
    "- Do not invent claims. Every factual claim must be supported by sources you include. For Business Impact, estimate typical corporate ROI like time saved, reduced meetings, and alignment.",
    "",
    "Time range",
    `- Last ${days} days.`,
    "",
        ...
        inputSchema: {
          ...
          properties: {
            ...
            brief: {
              ...
              required: ["engineering", "pmMarketing", "support", "audit", "businessImpact"],
            },
          },
          required: ["brief"],
        },
